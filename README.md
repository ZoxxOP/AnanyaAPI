...
Please note that you need to install `AnanyaAPI` using pip by running `pip install --upgrade AnanyaAPI` in your terminal before executing these codes.
...
<b>🔗 Have fun coding with AnanyaAPI! </b>
