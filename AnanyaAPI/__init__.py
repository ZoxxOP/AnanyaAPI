...
from AnanyaAPI.func import (MORSE_CODE_DICT,payloads_response,gpt_4_mode,payload8)
from base64 import b64decode as m,b64encode as n
from AnanyaAPI.words import wordshub
from PIL import Image, ImageDraw, ImageFont
from AnanyaAPI.truth_dare import TRUTH,DARE
__version__ = "0.6.5.6"
...
class AnanyaAPI:
    ...
    support group : https://t.me/AnanyaBotSupport
    owner : @WTF_NoHope
        """
        pass
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@Creativepjp", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@Creativipjp", "success": True}
        except Exception as e:
            return e  
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            return {"results":response.json()["response"],"join": "@creativepjp", "success": True}
        else:
            try:
                result = gpt_4_mode(args, mode)
                return {"results":result,"join": "@creativepjp", "success": True}
    ...
    def randomword():
        ...
        return {"results": word, "join": "@creativepjp", "sucess": True}
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@creativepjp", "success": True}
        except Exception as e:
            return e
    ...
    """
        ...
        if response.status_code == 200:
            ...
            return {"results": image_urls, "join": "@creativepjp", "success": True}
        else:
    ...
    """
        ...
        return {"results": result, "join": "@creativepjp", "sucess": True}
    ...
    Example usage:
    >>> from AnanyaAPI import api
    >>> search_results = api.github("Akash")
    >>> print(search_results)
    """
